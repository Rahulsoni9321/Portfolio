...
const ProjectContent = ({
  ...
  Techstack:string[]
   ...
   let id=1;
  return (
    <motion.div whileInView={{opacity:1,x:0}} initial={{opacity:0,x:-100}} transition={{duration:0.2}} className="overflow-auto flex-grow flex gap-8 flex-col justify-between items-center h-full  md:p-4  text-white hover:shadow-lg hover:shadow-white/30 hover:border hover:border-1 hover:border-gray-300 hover:bg-black transform transition duration-200 hover:text-white hover:scale-105 rounded-xl delay-0.6 ">
