  ...
  return (
    <div className="w-11/12 2xl:max-w-7xl md:mx-auto  flex md:flex-row flex-col items-center justify-center gap-12 md:mb-12">
      <div className="flex-grow   flex flex-col gap-8 justify-center items-center ">
        <motion.div whileInView={{opacity:1}} initial={{opacity:0}} transition={{duration:0.4}} className=" text-3xl md:text-6xl font-bold bg-clip-text text-transparent  bg-gradient-to-r from-[#45337d] via-[#d6b3e8] to-[#f7cee7]">
          Get in Touch...
        </motion.div>
